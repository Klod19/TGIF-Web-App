...
var table= document.getElementById("myTable"); //gets the httml table "myTable"
var dataList = document.getElementById("senate-data");//gets the HTML table body by its id
