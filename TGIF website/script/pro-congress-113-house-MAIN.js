...
var dataList = document.getElementById("house-data"); //gets the table from HTML
var reprs = data.results[0].members; //gets the array "members, which has objects as elements
