...
/*var dataList = document.getElementById("senate-data"); //why does it say "not defined"?
dataList.innerHTML = JSON.stringify(data, null, 2); //on dataList I tried the method "textContent"; also good? WHY should i use .stringify?*/
...
// is the stuff above correct? it shows also elements OUTSIDE of the array
console.log(row);
...
/*function addBands(){
    ...
    for (var i = 0; i < myBandList.length; i++){
        ...
        var textNode = document.createTextNode(myBandList[i]);
